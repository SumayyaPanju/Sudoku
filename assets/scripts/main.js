...
//Adding event listeners to radio buttons and linking it to functions created
lightModeOption.addEventListener("click", lightThemeActivation);
darkModeOption.addEventListener("click", darkThemeActivation);
